...
public interface Copyright
{
    ...
    //                                                                                         built=20180411 is automatically set by the build (see build.xml)
    public static String version   = "Open Source Software, JTOpen 9.4, codebase 5770-SS1 V7R3M0.00 built=20180411 @U4";  
