...
class PortMapper
{
    ...
    static SocketContainer getServerSocket(String systemName, int service, SSLOptions useSSL, SocketProperties socketProperties, boolean mustUseNetSockets) throws IOException
    {
        ...
        if (srvPort == AS400.USE_PORT_MAPPER)
        {
            ...
            // Hardcoded service mapper port to 8449 to enable usage from the Mendix Cloud via SSH tunnel (Clyde Waal, Mendix, 30-05-2018)
            ...
            Socket pmSocket = getSocketConnection(systemName, 8449, socketProperties); //@timeout2
